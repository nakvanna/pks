        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return Promise.all([self.$store.dispatch('fetchGroupSections'), self.$store.dispatch('fetchSections'), self.$store.dispatch('fetchLevels'), self.$store.dispatch('fetchShifts'), self.$store.dispatch('fetchStudyClasses'), self.$store.dispatch('fetchCollections'), self.$store.dispatch('fetchYears')]).then(function () {
                self.$vs.loading.close();
              });

            ...
            <vx-card no-shadow>
                ...
                <div class="vx-row">
                    ...
                    <div class="vx-col md:w-3/4 mt-20 flex">
                        ...
                        <vs-input class="w-1/3 ml-1 mr-1" placeholder="ភេទ" />
                        <vs-input class="w-1/3 ml-1" placeholder="ថ្ងៃខែឆ្នាំកំណើត" />
                    </div>
                </div>
                <vs-divider/>
                <!-- Save & Reset Button -->
